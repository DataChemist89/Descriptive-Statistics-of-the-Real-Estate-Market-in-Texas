...
- This project applies descriptive statistical techniques using the R programming language to analyze real estate market data for a company based in Texas. The goal was to explore and summarize the key characteristics of the dataset, providing an overview of market trends through measures of central tendency, dispersion, graphical visualizations, and distributions.
-  The final project was presented in RMarkdown and converted to PDF format. <br>

![](https://github.com/DataChemist89/Descriptive-Statistics-of-the-Real-Estate-Market-in-Texas/blob/main/project_banner.jpg)
